...
public class LogAndContinueSentryExceptionHandler extends SentryExceptionHandler implements DeserializationExceptionHandler {
    private static final Logger log = LoggerFactory.getLogger(LogAndContinueSentryExceptionHandler.class);

    public LogAndContinueSentryExceptionHandler() {
        super();
    }
